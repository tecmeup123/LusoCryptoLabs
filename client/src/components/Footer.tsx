      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="https://t.me/telmotalks" className="text-gray-400 hover:text-[#8b0000] transition-colors">
        ...
        <div className="mt-8 pt-8 border-t border-white/10 text-center text-gray-400">
          ...
          <p className="text-sm">
            <a href="mailto:contact@lusocryptolabs.xyz" className="text-gray-400 hover:text-[#8b0000] transition-colors">Contact us</a> for custom-branded solutions.
          </p>
        </div>
      </div>
    </footer>
